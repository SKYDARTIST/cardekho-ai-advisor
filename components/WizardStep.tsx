...
export default function WizardStep({
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      ...
      {/* Question */}
      <h2
        className="font-bold text-2xl md:text-3xl leading-tight mb-2"
            ...
            <button
              ...
              style={{
                ...
                background: isSelected
                  ? 'linear-gradient(135deg, rgba(255,85,0,0.08) 0%, rgba(255,85,0,0.04) 100%)'
                  : 'var(--surface)',
                transform: isSelected ? 'scale(1.02)' : 'scale(1)',
                boxShadow: isSelected ? '0 0 20px rgba(255,85,0,0.12)' : 'none',
              }}
            >
              {isSelected && (
                <span
              ...
              <span className="text-3xl mb-3 select-none">{opt.emoji}</span>
              <span
